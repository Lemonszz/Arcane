package party.lemons.magicmod.item;
...
public class ModItems
{
	...
	{
		ModelLoader.setCustomModelResourceLocation(spellTome, 0, new ModelResourceLocation(ModConstants.MODID + ":spell_tome", "inventory"));
		ModelLoader.setCustomModelResourceLocation(manaPotion, 0, new ModelResourceLocation(ModConstants.MODID + ":mana_potion", "inventory"));
	}
}
