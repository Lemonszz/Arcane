package party.lemons.magicmod.client.render;
 ...
 */
public class RenderFirestorm extends Render<EntityFirestormProjectile>
{
	private final float scale;

	public RenderFirestorm(RenderManager renderManagerIn)
	{
	 ...
	 */
	public void doRender(EntityFirestormProjectile entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
	 ...
	 */
	protected ResourceLocation getEntityTexture(EntityFirestormProjectile entity)
	{
